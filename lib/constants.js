...
export const MAJOR_CUSTOMERS = [
  { name: "Emirates NBD Bank", sector: "Banking & Finance", note: "Branch security and structured cabling rollout." },
  { name: "Four Seasons Hotel", sector: "Hospitality", note: "CCTV, access control, and AV integration." },
  { name: "TCIL", sector: "Telecom", note: "Telecom infrastructure supply and support." },
  { name: "Saudi Railways", sector: "Transportation", note: "Station security and PA/VA systems." },
  { name: "Al Rajhi", sector: "Banking & Finance", note: "Multi-branch access control deployment." },
  { name: "Hellmann Worldwide Logistics", sector: "Logistics", note: "Warehouse CCTV and perimeter security." },
  { name: "SIG Group of Companies", sector: "Industrial", note: "Electromechanical and power distribution works." },
  { name: "Baud Telecom Company", sector: "Telecom", note: "Structured cabling and network infrastructure." },
  { name: "Trans Telecom Company", sector: "Telecom", note: "IP PBX and telecom systems integration." },
  { name: "Ebttikar Technology", sector: "Technology", note: "Smart building and automation systems." },
  { name: "Al Arab Contracting Co", sector: "Construction", note: "MEP and ELV coordination on commercial builds." },
  { name: "Madaf Contracting Co", sector: "Construction", note: "Fire detection and suppression installation." },
];
